...
function randomTable(tab){
    ...
    function cddisplay() {
        ...
        g1Timer.textContent = 'Time before next question :'+ g1count;
    };
...
function getQuestion(){
    ...
    var g1qstn = randomTable(g1Qstions);
  ...
  var g1cl1 = g1sp1.addEventListener("click", Score);
  var g1cl2 = g1sp2.addEventListener("click", Score);
  var g1cl3 = g1sp3.addEventListener("click", Score);
  var g1cl4 = g1sp4.addEventListener("click", Score);
